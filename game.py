...
class Viewer():
    ...
    def __init__(self,width=690,height=400,fps=60):
        ...
        # walls
        self.static = [pymunk.Segment(self.space.static_body, (10, 50), (300, 50), 3)
        ...
        self.static[1].color = (255,0,0)
        self.static[2].color = (0,255,0)
        self.static[3].color = (255,0,0)
        
        # rounded shape
        self.rounded = [pymunk.Segment(self.space.static_body, (500, 50), (520, 60), 3)
                ...
                # static platforms
        self.platforms = [pymunk.Segment(self.space.static_body, (170, 50), (270, 150), 3)
